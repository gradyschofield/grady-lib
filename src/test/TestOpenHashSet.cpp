...
TEST_CASE("OpenHashSet iterator constructing vector"){
    static_assert(std::forward_iterator<OpenHashSet<int>::iterator>);
    static_assert(std::forward_iterator<OpenHashSet<int>::const_iterator>);
    OpenHashSet<int> s;
    s.insert(4);
    s.insert(4);
    s.insert(3);
